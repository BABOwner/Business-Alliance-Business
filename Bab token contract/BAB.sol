...
contract BAB is ERC20,Ownable {
    ...
    address public wallet = 0xE03E23C8ba35E9B6bC13AE1b7731fDaA7ac01123;
    event DividendsDistributed(address indexed from, uint256 weiAmount);
    event Claim(address indexed account, uint256 amount, bool indexed automatic);
    event DividendWithdrawn(address indexed to, uint256 weiAmount);
    mapping(address => bool) public noDevidends;
    address public seter;
    constructor() ERC20('Business Alliance Business', 'BAB'){
        claimWait = 3600;
